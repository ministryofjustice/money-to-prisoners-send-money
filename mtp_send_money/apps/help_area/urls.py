...
urlpatterns = [
    ...
    re_path(r'^help/apply-for-exemption/$',
        views.HelpView.as_view(
    ...
    re_path(r'^help/bank-transfer-issues/$',
        RedirectView.as_view(url=reverse_lazy('help_area:help-sent-payment'), permanent=True)),
    re_path(r'^help/payment-delay/$',
        RedirectView.as_view(url=reverse_lazy('help_area:help-sent-payment'), permanent=True)),
    re_path(r'^help/prisoner-moved-or-released/$',
        RedirectView.as_view(url=reverse_lazy('help_area:help-sent-payment'), permanent=True)),
    ...
    re_path(r'^contact-us/$',
        ...
        name='submit_ticket'),
    re_path(r'^contact-us/success/$', views.ContactSuccessView.as_view(), name='feedback_success'),
    re_path(r'^help/with-making-a-payment/contact-us/$',
        views.ContactNewPaymentView.as_view(),
        name='contact-us-new-payment'),
    re_path(r'^help/with-a-payment-i-sent/contact-us/$',
